...
public class ThunderousFortunesPLTEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(ThunderousFortunesPLTEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/ThunderousFortunesPLTIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/ThunderousFortunesPLTIW/InitOutcome.xml").getDocumentElement();
